...
// ════════════════════════════════════════════════════════════════
// search.php — siheonlee.com 검색 엔드포인트  (v0.3.1)
// ════════════════════════════════════════════════════════════════
//
...
<body>
    ...
    <section>
        <form class='home-search' action='/search.php' method='get' role='search'>
            <input type='search' name='q' value="<?= $q_attr ?>" placeholder='글 검색...' aria-label='Search' autofocus>
