...
> **v1.2.2 한 줄 요약** — `yaml_parser` 가 multi-line inline list (`[\n  'a',\n  'b'\n]`) 를 지원. v1.1.5 의 `exclude_urls` 가 multi-line 형태일 때 silently scalar `'['` 로 파싱돼 dormant 였던 차단이 의도대로 발효 (정본 site.yaml 의 26 URL). 누적 기능은 [§ 16](#16-업데이트-로그) 표 참조.
