...
| 위치 | 설정 |
|---|---|
| `site.yaml` | 도메인·name·copyright·lang·default_og_image / `category_per_page`·`category_preview_per_page` / robots.txt / reserved_slugs / warn_on_* / `description_truncate` / `images:` / `jsonld:` / `php_globals:` / `error_404_title`·`search_title` |
